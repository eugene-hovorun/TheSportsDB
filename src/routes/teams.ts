...
// Team detail page
router.get("/team/:id", async (req: Request, res: Response, next: NextFunction) => {
  try {
...
router.get("/api/team/:id/events/next", async (req: Request, res: Response, next: NextFunction) => {
  try {
...
router.get("/api/team/:id/events/last", async (req: Request, res: Response, next: NextFunction) => {
  try {
